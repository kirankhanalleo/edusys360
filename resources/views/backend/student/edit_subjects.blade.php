...
<main>
    ...
    <div class="data-table large-table">
        <div style="display:flex; justify-content:space-between;">
            <div><h2>Edit Subject</h2></div>
        </div>
        <hr>
        <div class="modal-body" style="margin-bottom: 1.5rem;">
            <form action="{{ route('update.subjects',$editData->id) }}" method="post">
                @csrf
                ...
                <button type="submit" class="create" style="margin-bottom: 1rem;">Update Subject</button>
            </form>    
        </div>
    </div>
</main>
