...
<main>
    ...
    <div class="data-table large-table">
        <div><h2>Promote Student</h2></div>
        <hr>
        <div class="modal-body" style="margin-bottom: 1.5rem;">
            <form action="{{ route('promote.student.save',$editData->student_id) }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="input-form">
                    ...
                    <div class="row">
                        ...
                        <button type="submit" class="create user">Promote Student</button>
                    </div> 
                </div>
            </form>  
        </div>
