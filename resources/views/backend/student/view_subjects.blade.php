...
<div class="main-content">
  <div class="col-12">
    <div class="card">
      <a href="{{ route('add.subject') }}" class="add-user btn rounded-pill btn-primary mb-5">Create New Subject</a>
      <div class="card-header" style="padding-top:30px;">
        <h4>Viewing Subects</h4>
      </div>
      <div class="card-body">
                ...
                <table class="table table-striped dataTable no-footer" id="table-1" role="grid" aria-describedby="table-1_info">
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"  style="width: 232.698px;">Subjects</th>
                  ...
                  <tbody>
                    ...
                    @foreach ( $allData as $key => $subjects ) 
                    <tr role="row" class="odd">
                      <td class="sorting_1">{{ $key+1 }}</td>
                      <td>{{ $subjects->name }}</td>
                      <td>
                        <a href="{{ route('edit.subject',$subjects->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('delete.subject',$subjects->id) }}" class="btn btn-danger ml-1" id="deleteSubject" onMouseOver="this.style.color='#FFFFFF'">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
