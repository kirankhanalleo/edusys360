...
<div class="main-content">
  <div class="col-12">
    <div class="card">
      <a href="{{ route('add.fee.category') }}" class="add-user btn rounded-pill btn-primary mb-5">Create Fee Category</a>
      <div class="card-header" style="padding-top:30px;">
        <h4>Viewing Fee Categories</h4>
      </div>
      <div class="card-body">
                ...
                <table class="table table-striped dataTable no-footer" id="table-1" role="grid" aria-describedby="table-1_info">
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"  style="width: 232.698px;">Name</th>
                  ...
                  <tbody>
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td>{{ $category->name }}</td>
                      <td>
                        <a href="{{ route('edit.fee.category',$category->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('delete.fee.category',$category->id) }}" class="btn btn-danger ml-1" id="deleteFeeCategory" onMouseOver="this.style.color='#FFFFFF'">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
