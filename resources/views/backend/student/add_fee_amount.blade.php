    ...
    <div class="col-12 col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4>CREATE FEE AMOUNT</h4>
            </div>
            <form action="{{ route('create.fee.amount') }}" method="post" id="register-form">
                @csrf
                <div class="card-body">
                    <div class="col-md-12">
                        <div class="add_item">
                        ...
                        <input type="submit" class=" btn btn-success rounded-pill" value="Set Fee Amount">
                    </div>
                </div>
            </form>
        </div>
