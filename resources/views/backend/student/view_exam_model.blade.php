...
<div class="main-content">
  <div class="col-12">
    <div class="card">
      <a href="{{ route('add.exam.model') }}" class="add-user btn rounded-pill btn-primary mb-5">Create Exam Model</a>
      <div class="card-header" style="padding-top:30px;">
        <h4>Viewing Exam Model</h4>
      </div>
      <div class="card-body">
                ...
                <table class="table table-striped dataTable no-footer" id="table-1" role="grid" aria-describedby="table-1_info">
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"  style="width: 232.698px;">Exam Type</th>
                  ...
                  <tbody>
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td>{{ $exam->name }}</td>
                      <td>
                        <a href="{{ route('edit.exam.model',$exam->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('delete.exam.model',$exam->id) }}" class="btn btn-danger ml-1" id="deleteExam" onMouseOver="this.style.color='#FFFFFF'">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
