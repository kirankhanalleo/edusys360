@php
    $admission_fee = App\Models\FeeCategoryAmount::where('fee_category_id', '1')->where('class_id', $data->class_id)->first();
            ...
            <div class="StudentDetails">
                ...
                <table border="1" cellpadding="5" class="stripped-table">
                    ...
                    <tbody>
                        <tr>
                            <td width>1</td>
                            <td width="85%;" style="text-align: left; padding-left:10px;">Admission Fee</td>
                            <td>{{ $grossFee }}</td>
                        </tr>
                        <tr>
