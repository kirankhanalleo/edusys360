                ...
                <table class="table table-striped dataTable no-footer" id="table-1" role="grid" aria-describedby="table-1_info">
                  ...
                  <tbody>
                    ...
                    <tr role="row" class="odd">
                      ...
                      {{-- <td>
                        <a href="{{ route('edit.fee.category',$amount->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('delete.fee.category',$amount->id) }}" class="btn btn-danger ml-1" id="deleteFeeCategory" onMouseOver="this.style.color='#FFFFFF'">Delete</a>
                      </td> --}}
                    </tr>
                    @endforeach
                  </tbody>
