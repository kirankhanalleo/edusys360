...
<div class="main-content">
  <div class="col-12">
    <div class="card">
      <a href="{{ route('add.year') }}" class="add-user btn rounded-pill btn-primary mb-5">Create New Year</a>
      <div class="card-header" style="padding-top:30px;">
        <h4>Viewing Academic Year</h4>
      </div>
      <div class="card-body">
                ...
                <table class="table table-striped dataTable no-footer" id="table-1" role="grid" aria-describedby="table-1_info">
                  ...
                  <tbody>
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td>{{ $year->name }}</td>
                      <td>
                        <a href="{{ route('edit.year',$year->id) }}" class="btn btn-primary">Edit</a>
                        <a href="{{ route('delete.year',$year->id) }}" class="btn btn-danger ml-1" id="deleteYear" onMouseOver="this.style.color='#FFFFFF'">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
