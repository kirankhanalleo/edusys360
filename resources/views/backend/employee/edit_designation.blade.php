...
<main>
    ...
    <p class="text-muted pt"><b><a href="{{ route('dashboard') }}">Home</a></b> - <a href="{{ route('view.designation') }}">Designation</a> </p>
    <div class="data-table large-table">
        <div style="display:flex; justify-content:space-between;">
            <div><h2>Edit Designation</h2></div>
        </div>
        <hr>
        <div class="modal-body" style="margin-bottom: 1.5rem;">
            <form action="{{ route('update.designation',$editData->id) }}" method="post">
                ...
                <button type="submit" class="create" style="margin-bottom: 1rem;">Update Designation</button>
            </form>    
        </div>
    </div>
</main>
