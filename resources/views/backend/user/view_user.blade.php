...
<div class="main-content">
  <div class="col-12">
    <div class="card">
      <a href="{{ route('add.user') }}" class="add-user btn rounded-pill btn-primary mb-5">Create New User</a>
                ...
                <table class="table table-striped dataTable no-footer" id="table-1" role="grid" aria-describedby="table-1_info">
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"  style="width: 132.698px;">Role</th>
                      <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"  style="width: 132.698px;">Name</th>
                      <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"  style="width: 132.698px;">Email</th>
                      <th class="sorting" tabindex="0" aria-controls="table-1" rowspan="1" colspan="1"  style="width: 132.698px;">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    ...
                    <tr role="row" class="odd">
                      ...
                      <td>
                        ...
                        <a href="{{ route('delete.user',$user->id) }}" class="btn btn-danger ml-1" id="deleteUser" onMouseOver="this.style.color='#FFFFFF'">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
